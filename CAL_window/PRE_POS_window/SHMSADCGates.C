...
void SHMSADCGates::SlaveBegin(TTree * /*tree*/)
{
  ...
  h1PHGCERPulseTimeStarttimeDiff_CalCut = new TH1F*[14];
  
  //****************** HgCer( 4 pmts) **********************************//
  h1PHGCERPulseTime              = new TH1F*[14];
  h1PHGCERPulseTimeStarttimeDiff = new TH1F*[14];
  h1PHGCERPGoodAdcTdcDiffTime = new TH1F*[14];
  h1PHGCERPGoodAdcTdcDiffTime_Mult = new TH1F*[14];
  h1PHGCERPulseTimeVsPulseAmp = new TH2F*[14];
  h1PHGCERPulseTimeStarttimeDiffMult = new TH1F*[14];
  h1PHGCERPulseTimeStarttimeDiffMultCut = new TH1F*[14];
  h1PHGCERPulseTimeVsPulseAmpMultCut = new TH2F*[14];
  h1TimeVsAmpMult =new TH2F*[14];
  h1TimeVsAmpCal = new TH2F*[14];
  h1TimeVsAmpMultCal=new TH2F*[14];
  h1goodTimeVsAmpMult=new TH2F*[14];

  h1goodTimeCal= new TH1F*[14];
  h1goodTimeMultCal= new TH1F *[14];
  h1_gooddelta =new TH1F*[14];
  h1_delta =new TH1F*[14];
...
Bool_t SHMSADCGates::Process(Long64_t entry)
{
  ...
  if(entry<10000000) { //Abort("end of the desired entry");
    ...
    for (Int_t i = 0; i < *Ndata_P_precal_posAdcPulseTime; i++) {
      ...
      h1PHGCERPulseTimeStarttimeDiff[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime); // no hit selection. Its adctdc time diff

      if(*P_ngcer_npeSum > 0.8)// all hits with electron 
	{
	  if(*P_gtr_dp>-15 && *P_gtr_dp<25)
	    {
	      h1_delta[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime); //delta cut on no hit selection
	      
	      h1_gooddelta[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[current_pmt]); //delta cut on hit selection
	    }
	  
	  h1PHGCERPulseTimeStarttimeDiff_CalCut[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime);  // adctdc time diff with multiplicity cut and calorimter cut
	  ...
	  h1goodTimeCal[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[current_pmt]); 
	}
      ...
      h1PHGCERPulseTimeVsPulseAmpMultCut[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[current_pmt], P_precal_goodPosAdcPulseAmp[current_pmt]); // hit selection with no cuts
      
      if (P_precal_goodPosAdcMult[current_pmt] == 1) //hits with mult
	{
	  h1PHGCERPulseTimeStarttimeDiffMult[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime);// no hit selection with multiplicity cut
	  
	  h1PHGCERPGoodAdcTdcDiffTime_Mult[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[current_pmt]);
	  
	  h1goodTimeVsAmpMult[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[current_pmt], P_precal_goodPosAdcPulseAmp[current_pmt]);
	  ...
	  if(*P_ngcer_npeSum > 0.8)//hits with electron and Multiplicity
	    {
	      ...
	      h1goodTimeMultCal[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[current_pmt]);
	    }   
	}  
    }
...
void SHMSADCGates::Terminate()
{
  ...
  for (Int_t ipmt=0; ipmt < 14; ipmt++) {
    ...
    c1->Divide(2,1);
    int ipmtt=0;
    legend[ipmtt] = new TLegend(0.1,0.8,0.5,0.9);
    ...
    h1PHGCERPulseTimeStarttimeDiff_CalCut[ipmt]->GetXaxis()->SetTitle("-P.cal.pr.posAdcPulseTime + P.hod.starttime");
    ...
    h1PHGCERPulseTimeStarttimeDiff[ipmt]->GetXaxis()->SetTitle("-P.cal.pr.posAdcPulseTime + P.hod.starttime");
    ...
    legend[ipmtt]->AddEntry(h1PHGCERPulseTimeStarttimeDiff_CalCut[ipmt],"Cal>0.8","l");
    legend[ipmtt]->AddEntry(h1PHGCERPulseTimeStarttimeDiffMultCut[ipmt],"mult = 1 & Cal","l");
    legend[ipmtt]->AddEntry(h1_delta[ipmt],"#delta >-15 && #delta <25 && Cal","l");
    ...
    h1PHGCERPulseTimeVsPulseAmp[ipmt]->GetXaxis()->SetTitle("-P.cal.pr.posAdcPulseTime + P.hod.starttime");
    h1PHGCERPulseTimeVsPulseAmp[ipmt]->GetYaxis()->SetTitle("P.cal.pr.posAdcPulseAmp");
    ...
    legend[ipmtt] = new TLegend(0.1,0.8,0.52,0.9);
    legend[ipmtt]->AddEntry(h1PHGCERPulseTimeStarttimeDiff[ipmt],"no hit selection", "l");
    ...
    h1TimeVsAmpMult[ipmt ]->GetXaxis()->SetTitle("-P.cal.pr.posAdcPulseTime + P.hod.starttime");
    h1TimeVsAmpMult[ipmt ] ->GetYaxis()->SetTitle("P.cal.pr.posAdcPulseAmp");
    ...
    h1TimeVsAmpCal[ipmt ]->GetXaxis()->SetTitle("-P.cal.pr.posAdcPulseTime + P.hod.starttime");
    h1TimeVsAmpCal[ipmt ] ->GetYaxis()->SetTitle("P.cal.pr.posAdcPulseAmp");
    ...
    legend[ipmtt] = new TLegend(0.1,0.8,0.48,0.9);
    legend[ipmtt]->AddEntry(h1PHGCERPulseTimeStarttimeDiff_CalCut[ipmt],"Cal","l");
    legend[ipmtt]->Draw();legend[ipmtt]->SetTextSize(0.04);
    //  delete legend[ipmtt];
    ...
    h1TimeVsAmpMultCal[ipmt ]->GetXaxis()->SetTitle("-P.cal.pr.posAdcPulseTime+ P.hod.starttime");
    h1TimeVsAmpMultCal[ipmt ] ->GetYaxis()->SetTitle("P.cal.pr.posAdcPulseAmp");
    ...
    legend[ipmtt]->Draw();
    //  delete legend[ipmtt];
   c1->SaveAs(Form("Plots/CAL_Pos_AdcTdc_pmt_%i.pdf", ipmt+1));
  ...
  for (Int_t ipmt=0; ipmt < 14; ipmt++) {
    ...
    h1PHGCERPGoodAdcTdcDiffTime[ipmt]->GetXaxis()->SetTitle("P.cal.pr.goodPosAdcTdcDiffTime");
    ...
    leg[ipmtt] = new TLegend(0.1,0.8,0.6,0.9);
    ...
    leg[ipmtt]->AddEntry(h1_gooddelta[ipmt], "good with #delta & Cal", "l");
    ...
    h1PHGCERPulseTimeVsPulseAmpMultCut[ipmt]->GetXaxis()->SetTitle("P.cal.pr.goodPosAdcTdcDiffTime");
    h1PHGCERPulseTimeVsPulseAmpMultCut[ipmt]->GetYaxis()->SetTitle("P.cal.pr.goodPosAdcPulseAmp");
    ...
    h1goodTimeVsAmpMult[ipmt]->GetXaxis()->SetTitle("P.cal.pr.goodAdcTdcDiffTime");
    h1goodTimeVsAmpMult[ipmt]->GetYaxis()->SetTitle("P.cal.pr.goodAdcPulseAmp");
    ...
    c0->SaveAs(Form("Plots/Good_CAL_Pos_AdcTdc_pmt_%i.pdf", ipmt+1));
    delete c0;
