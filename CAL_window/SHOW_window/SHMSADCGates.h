...
public :
   ...
   //*********GoodAdcTdcTimeDiff***********************//
   TTreeReaderValue<Int_t> Ndata_P_cal_goodAdcTdcDiffTime = {fReader, "Ndata.P.cal.fly.goodAdcTdcDiffTime"};
   TTreeReaderArray<Double_t> P_cal_goodAdcTdcDiffTime = {fReader, "P.cal.fly.goodAdcTdcDiffTime"};
