...
void SHMSADCGates::SlaveBegin(TTree * /*tree*/)
{
  ...
  h1PHGCERPulseTimeStarttimeDiff_CalCut = new TH1F*[224];
  
  //****************** HgCer( 4 pmts) **********************************//
  h1PHGCERPulseTime              = new TH1F*[224];
  h1PHGCERPulseTimeStarttimeDiff = new TH1F*[224];
  h1PHGCERPGoodAdcTdcDiffTime = new TH1F*[224];
  h1PHGCERPGoodAdcTdcDiffTime_Mult = new TH1F*[224];
  h1PHGCERPulseTimeVsPulseAmp = new TH2F*[224];
  h1PHGCERPulseTimeStarttimeDiffMult = new TH1F*[224];
  h1PHGCERPulseTimeStarttimeDiffMultCut = new TH1F*[224];
  h1PHGCERPulseTimeVsPulseAmpMultCut = new TH2F*[224];
  h1TimeVsAmpMult =new TH2F*[224];
  h1TimeVsAmpCal = new TH2F*[224];
  h1TimeVsAmpMultCal=new TH2F*[224];
  h1goodTimeVsAmpMult=new TH2F*[224];

  h1goodTimeCal= new TH1F*[224];
  h1goodTimeMultCal= new TH1F *[224];
  ...
  //*********************************************NGCER ****************************************************//
  // h1PNGCERPulseTime              = new TH1F*[224];
  // h1PNGCERPulseTimeStarttimeDiff = new TH1F*[224];

  // h1PNGCERPulseTimeStarttimeDiff_CalCut = new TH1F*[224];
  // h1PNGCERPGoodAdcTdcDiffTime = new TH1F *[224];
  // h1PNGCERPGoodAdcTdcDiffTime_Mult = new TH1F*[224];

  // h1PNGCERPulseTimeVsPulseAmp = new TH2F*[224];
  // h1PNGCERPulseTimeStarttimeDiffMult = new TH1F*[224];
  // h1PNGCERPulseTimeStarttimeDiffMultCut = new TH1F*[224];

  // h1PNGCERPulseTimeVsPulseAmpMultCut = new TH2F*[224];
  ...
  // h1PPRECALPosPulseTime                     = new TH1F*[224];
  // h1PPRECALPosPulseTimeStarttimeDiff        = new TH1F*[224];
  // h1PPRECALPosPulseTimeStarttimeDiffMult    = new TH1F*[224];
  // h1PPRECALPosPulseTimeStarttimeDiffMultCut = new TH1F*[224];
  // h1PPRECALPosPulseTimeStarttimeDiff_CalCut = new TH1F*[224];
  
  // h1PPRECALPosPulseTimeVsPulseAmp           = new TH2F*[224];
  // h1PPRECALPosPulseTimeVsPulseAmpMultCut    = new TH2F*[224];
  ...
  // h1PPRECALGoodPosAdcTdcDiffTime            = new TH1F*[224];
  // h1PPRECALGoodPosAdcTdcDiffTime            = new TH1F*[224];
  // h1PPRECALGoodPosAdcTdcDiffTime_Cut        = new TH1F*[224];
  // h1PPRECALGoodPosAdcTdcDiffTime_Cut        = new TH1F*[224];
  ...
  //   h1PPRECALPosPulseTimeVsPulseAmp[ipmt] = new TH2F(Form("PreCALPosPulseTimeVsPulseAmp%d",ipmt+1),Form("Pulse Time Vs Pulse Pos Amp PMT%d;Pulse Time(ns); Pulse Amp",ipmt+1),1000,-400, 0, 1000, 0, 1000);
  ...
  //   h1PPRECALPosPulseTimeStarttimeDiffMult[ipmt] = new TH1F(Form("PPRECALPosPulseTimeStarttimeDiffMult%d",ipmt+1),Form("Pulse Time with Mult PRECAL Pos PMT%d Start Time Subtracted;Time (ns);Counts",ipmt+1),1000,-400,0);
    
  //   h1PPRECALPosPulseTimeStarttimeDiffMultCut[ipmt] = new TH1F(Form("PPRECALPosPulseTimeStarttimeDiffMultCut%d",ipmt+1),Form("Pulse Time MultCut for SHMS PRECAL Pos PMT%d Start Time Subtracted;Time (ns);Counts",ipmt+1),1000,-400,0);
  ...
  //   h1PPRECALGoodPosAdcTdcDiffTime[ipmt] =  new TH1F(Form("PPRECALGoodPosAdcTdcDiffTime%d",ipmt+1),Form(" SHMS PRECAL GOOD Pos Adc Tdc Diff Time PMT_%d;Time (ns);Counts",ipmt+1),1000,-400,0);
    
  //   h1PPRECALGoodPosAdcTdcDiffTime_Cut[ipmt] =  new TH1F(Form("PPRECALGoodPosAdcTdcDiffTimeCut%d",ipmt+1),Form(" SHMS PRECAL Pos Adc Tdc Diff TimeCut%d;Time (ns);Counts",ipmt+1),1000,-400,0);
...
Bool_t SHMSADCGates::Process(Long64_t entry)
{
  ...
  if(entry<1000) {//Abort("end of the desired entry");
    ...
    for (Int_t i = 0; i < *Ndata_P_precal_posAdcPulseTime; i++) {
      ...
      h1PHGCERPulseTime[current_pmt]->Fill(-P_precal_posAdcPulseTime[i]);
      
      h1PHGCERPulseTimeStarttimeDiff[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime); // no selection adctdc time diff
      
      if(*P_ngcer_npeSum >0.8)// all hits with electron 
	{
	  h1PHGCERPulseTimeStarttimeDiff_CalCut[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime);  // adctdc time diff with mult electron

	  h1TimeVsAmpCal[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime, P_precal_posAdcPulseAmp[i]); // amplitude with electron

	  h1goodTimeCal[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[i]); //
	}
      
      h1PHGCERPulseTimeVsPulseAmp[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime,  P_precal_posAdcPulseAmp[i]);
      
      h1PHGCERPGoodAdcTdcDiffTime[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[current_pmt]);

      h1PHGCERPulseTimeVsPulseAmpMultCut[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[i], P_precal_goodPosAdcPulseAmp[i]);
      
      if (P_precal_goodPosAdcMult[current_pmt] == 1) //hits with mult
	{
	  h1PHGCERPulseTimeStarttimeDiffMult[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime);
	  
	  h1PHGCERPGoodAdcTdcDiffTime_Mult[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[current_pmt]);
	  
	  h1goodTimeVsAmpMult[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[i], P_precal_goodPosAdcPulseAmp[i]);
	  
	  h1TimeVsAmpMult[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime, P_precal_posAdcPulseAmp[i]);
	  
	  if(*P_ngcer_npeSum >0.8)//hits with electron and Multiplicity
	    {
	      h1PHGCERPulseTimeStarttimeDiffMultCut[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime);// all hit with elec and mult==1
	      
	      h1TimeVsAmpMultCal[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime,  P_precal_posAdcPulseAmp[i]);

	      h1goodTimeMultCal[current_pmt]->Fill(P_precal_goodPosAdcTdcDiffTime[i]);
	    }
	}    
    }
    ...
    //   // cout << "hits " << *Ndata_P_precal_posAdcPulseTime << endl;
      
    //   // cout << "error flag before Cut : " << P_precal_posAdcErrorFlag[i]<< endl;
      
    //   if (P_precal_posAdcErrorFlag[i] == 1) continue;
      
    //   // cout << "error flag: " << P_precal_posAdcErrorFlag[i]<< endl;
      
    //   // cout <<"initial counter: "<< P_precal_posAdcCounter[i] << endl;
      
    //   // if (P_precal_posAdcCounter[i] < 1 || P_precal_posAdcCounter[i] > 4) continue;
      
    //   //  cout <<"After counter: "<< P_precal_posAdcCounter[i] << endl;
    ...
    //   // cout <<"Pulse time : " <<  -P_precal_posAdcPulseTime[i]<<endl;
      
    //   h1PNGCERPulseTime[current_pmt]->Fill(-P_precal_posAdcPulseTime[i]);
      
    //   //cout <<"*****************"<< h1PNGCERPulseTime[current_pmt]->GetEntries()<<endl;
      
    //   h1PNGCERPulseTimeStarttimeDiff[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime);// all hits 
      
    //   if(P_precal_goodPosAdcMult[current_pmt] ==1)h1PNGCERPulseTimeStarttimeDiffMult[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime);// multiplicit cut
      
    //   if(*P_cal_etottracknorm >0.8)
    // 	{
    // 	  h1PNGCERPulseTimeStarttimeDiff_CalCut[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime); // electron cuts 
	  
    // 	  if(P_precal_goodPosAdcMult[current_pmt] ==1)
    // 	    {
    // 	      h1PNGCERPulseTimeStarttimeDiffMultCut[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime); //all hits + multiciplity 
    // 	      h1PNGCERPulseTimeVsPulseAmpMultCut[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime,  P_precal_posAdcPulseAmp[i]);// cal cut with mulitplicity 2D
    // 	    }
    // 	}
    //   h1PNGCERPulseTimeVsPulseAmp[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime ,  P_precal_posAdcPulseAmp[i]);    
    // }
    
    
    // for(Int_t i =0; i<*Ndata_P_precal_goodPosAdcTdcDiffTime; i++)
    //   {
    // 	// cout <<"NdataPngcer:    " <<*Ndata_P_precal_goodPosAdcTdcDiffTime<<endl;
    // 	//Int_t current_pmt = P_hgcer_adcCounter[i] - 1;
    // 	if(P_precal_goodPosAdcMult[i] ==1)
    // 	  {
    // 	    // cout <<"Multiplicity:  "<< P_precal_goodPosAdcMult[i] << endl;
	    
    // 	    h1PNGCERPGoodAdcTdcDiffTime[i]->Fill(P_precal_goodPosAdcTdcDiffTime[i]);
    // 	    // cout << "Entry: " << h1PNGCERPGoodAdcTdcDiffTime[i]->GetEntries()<< endl;
    // 	    if(*P_cal_etottracknorm >0.8){h1PNGCERPGoodAdcTdcDiffTime_Mult[i]->Fill(P_precal_goodPosAdcTdcDiffTime[i]); //cout << "Entry with cut: " << h1PNGCERPGoodAdcTdcDiffTime_Mult[i]->GetEntries()<< endl;
    // 	    }
    // 	  }
    //   }
    ...
    //************************************PRE SHOWER ******************************//
    // its one plane and contains 14 paddle. each paddle contains 14 pmts on each side. The two side are named as positive and posative side.
    //so we  have to loop over each side.
    
    //******************** this part is for Posative side of the paddle**************************//
    ...
    //   if (P_precal_goodPosAdcMult[current_pmt] == 1)h1PPRECALPosPulseTimeStarttimeDiffMult[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime); // mult cut only
      
    //   if(*P_cal_etottracknorm >0.8)
    // 	{ 
    // 	  h1PPRECALPosPulseTimeStarttimeDiff_CalCut[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime);// elec cut
	  
    // 	  if (P_precal_goodPosAdcMult[current_pmt] == 1)
    // 	    {
    // 	      h1PPRECALPosPulseTimeStarttimeDiffMultCut[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime);// mult and elec cut
    // 	      h1PPRECALPosPulseTimeVsPulseAmpMultCut[current_pmt]->Fill(-P_precal_posAdcPulseTime[i] + *P_hod_starttime,  P_precal_posAdcPulseAmp[i]);// cal cut with mulitplicity 2D
    // 	    }
	  
    // 	}
      
      
    //   h1PPRECALPosPulseTimeVsPulseAmp[current_pmt]->Fill(-P_precal_posAdcPulseTime[i]+ *P_hod_starttime , P_precal_posAdcPulseAmp[i]);
    // }
    
    //*******Good Adc Tdc Diff Time for preshower Posative side **********************//
    // for (Int_t i = 0; i <*Ndata_P_precal_goodPosAdcTdcDiffTime; i++){
    //   //  cout << *Ndata_P_precal_goodPosAdcTdcDiffTime << endl;
    //   if (P_precal_goodPosAdcMult[i] == 1)
    // 	{
    ...
    // 	  if(*P_cal_etottracknorm>0.8)
    // 	    {
    // 	      h1PPRECALGoodPosAdcTdcDiffTime_Cut[i]->Fill(P_precal_goodPosAdcTdcDiffTime[i]); 
    // 	      // cout << "hi"<<endl;
    // 	    }
    // 	}
    // }
...
void SHMSADCGates::Terminate()
{
  ...
  // TH1F* PHGCPULSETIME[224];
  // TH1F* PHGCPULSETIMEDIFF[224];
  // TH1F* PHGCPULSETIMEDIFFCUT[224];
  // for (Int_t ipmt = 0; ipmt < 4; ipmt++) {
  ...
  // TH1F* PNGCPULSETIME[224];
  // TH1F* PNGCPULSETIMEDIFF[224];
  // for (Int_t ipmt = 0; ipmt < 4; ipmt++) {
  ...
  // TH1F* PPRECALNEGPULSETIME[224];
  // TH1F* PPRECALNEGPULSETIMEDIFF[224];
  // TH1F* PPRECALPOSPULSETIME[224];
  // TH1F* PPRECALPOSPULSETIMEDIFF[224];
  // for (Int_t ipmt = 0; ipmt < 14; ipmt++) {
  //   PPRECALNEGPULSETIME[ipmt] = dynamic_cast<TH1F*> (GetOutputList()->FindObject(Form("PPRECALPosPulseTime%d",ipmt+1)));
  //   PPRECALNEGPULSETIMEDIFF[ipmt] = dynamic_cast<TH1F*> (GetOutputList()->FindObject(Form("PPRECALPosPulseTimeStarttimeDiff%d",ipmt+1)));
  ...
  // for (Int_t ipmt = 0; ipmt < 18; ipmt++) {
  //   PHODO1xNEGPULSETIMEDIFF[ipmt] = dynamic_cast<TH1F*> (GetOutputList()->FindObject(Form("PHODO1xPosPulseTimeStarttimeDiff%d",ipmt+1)));
  //   PHODO1xPOSPULSETIMEDIFF[ipmt] = dynamic_cast<TH1F*> (GetOutputList()->FindObject(Form("PHODO1xPosPulseTimeStarttimeDiff%d",ipmt+1)));
  //   PHODO1yNEGPULSETIMEDIFF[ipmt] = dynamic_cast<TH1F*> (GetOutputList()->FindObject(Form("PHODO1yPosPulseTimeStarttimeDiff%d",ipmt+1)));
  //   PHODO1yPOSPULSETIMEDIFF[ipmt] = dynamic_cast<TH1F*> (GetOutputList()->FindObject(Form("PHODO1yPosPulseTimeStarttimeDiff%d",ipmt+1)));
  //   PHODO2xNEGPULSETIMEDIFF[ipmt] = dynamic_cast<TH1F*> (GetOutputList()->FindObject(Form("PHODO2xPosPulseTimeStarttimeDiff%d",ipmt+1)));
  //   PHODO2xPOSPULSETIMEDIFF[ipmt] = dynamic_cast<TH1F*> (GetOutputList()->FindObject(Form("PHODO2xPosPulseTimeStarttimeDiff%d",ipmt+1)));
  //   PHODO2yNEGPULSETIMEDIFF[ipmt] = dynamic_cast<TH1F*> (GetOutputList()->FindObject(Form("PHODO2yPosPulseTimeStarttimeDiff%d",ipmt+1)));
  ...
  // Int_t AeroPosMin = TMath::Mean(7,AERONEG_Window) - 35;
  // Int_t AeroPosMax = TMath::Mean(7,AERONEG_Window) + 20;
  ...
  // Int_t PRECALPosMin[224]; Int_t PRECALPosMax[224];
  // Int_t PRECALPosMin[224]; Int_t PRECALPosMax[224];
  // for (Int_t ipmt = 0; ipmt < 14; ipmt++) {  
  //   (PRECALPOS_Window[ipmt] == 1e+38) ? PRECALPosMin[ipmt] = -200 : PRECALPosMin[ipmt] = PRECALPOS_Window[ipmt] - 10;
  //   (PRECALNEG_Window[ipmt] == 1e+38) ? PRECALPosMin[ipmt] = -200 : PRECALPosMin[ipmt] = PRECALNEG_Window[ipmt] - 10;
  //   (PRECALPOS_Window[ipmt] == 1e+38) ? PRECALPosMax[ipmt] = 200 : PRECALPosMax[ipmt] = PRECALPOS_Window[ipmt] + 10;
  //   (PRECALNEG_Window[ipmt] == 1e+38) ? PRECALPosMax[ipmt] = 200 : PRECALPosMax[ipmt] = PRECALNEG_Window[ipmt] + 10;
  // }
  ...
  // Int_t DCMin[224]; Int_t DCMax[224];
  // for (Int_t ipmt = 0; ipmt < 12; ipmt++) {
  ...
  */
  ...
  // // SHMSWindows << Form("paero_adcPosTimeWindowMin = %d\npaero_adcPosTimeWindowMax = %d\npaero_adcPosTimeWindowMin = %d\npaero_adcPosTimeWindowMax = %d\n",AeroPosMin,AeroPosMax,AeroPosMin,AeroPosMax) <<  endl;
  // SHMSWindows << Form(";Values obtained from Run %s",option.Data()) << endl;
  ...
  // SHMSWindows << Form("pcal_pos_AdcTimeWindowMin = %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d",PRECALPosMin[0],PRECALPosMin[1],PRECALPosMin[2],PRECALPosMin[3],PRECALPosMin[224],PRECALPosMin[5],PRECALPosMin[6],PRECALPosMin[7],PRECALPosMin[8],PRECALPosMin[9],PRECALPosMin[10],PRECALPosMin[11],PRECALPosMin[224],PRECALPosMin[13]) << endl;
  // SHMSWindows << Form("\npcal_pos_AdcTimeWindowMin = %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d",PRECALPosMin[0],PRECALPosMin[1],PRECALPosMin[2],PRECALPosMin[3],PRECALPosMin[224],PRECALPosMin[5],PRECALPosMin[6],PRECALPosMin[7],PRECALPosMin[8],PRECALPosMin[9],PRECALPosMin[10],PRECALPosMin[11],PRECALPosMin[224],PRECALPosMin[13]) << endl;
  // SHMSWindows << Form("\npcal_pos_AdcTimeWindowMax = %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d",PRECALPosMax[0],PRECALPosMax[1],PRECALPosMax[2],PRECALPosMax[3],PRECALPosMax[224],PRECALPosMax[5],PRECALPosMax[6],PRECALPosMax[7],PRECALPosMax[8],PRECALPosMax[9],PRECALPosMax[10],PRECALPosMax[11],PRECALPosMax[224],PRECALPosMax[13]) << endl;
  // SHMSWindows << Form("\npcal_pos_AdcTimeWindowMax = %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d",PRECALPosMax[0],PRECALPosMax[1],PRECALPosMax[2],PRECALPosMax[3],PRECALPosMax[224],PRECALPosMax[5],PRECALPosMax[6],PRECALPosMax[7],PRECALPosMax[8],PRECALPosMax[9],PRECALPosMax[10],PRECALPosMax[11],PRECALPosMax[224],PRECALPosMax[13]) << endl;
  // SHMSWindows << Form("\n;Values obtained from Run %s",option.Data()) << endl;
  ...
  for (Int_t ipmt=0; ipmt < 224; ipmt++) {
    ...
    c1->SaveAs(Form("wide_CAL_pmt_%i.pdf", ipmt+1));
  ...
  // //***************************************Preshower ***************************//
  // for (Int_t ipmt=0; ipmt < 14; ipmt++) {
  //   TCanvas *c3 = new TCanvas("c3", "AdcTdcPos" , 600, 600);
  //   c3->Divide(2,2);//posative
