...
Bool_t SHMSADCGates::Process(Long64_t entry)
{
  ...
  if(entry<10000000) { //Abort("end of the desired entry");
    ...
    for (Int_t i = 0; i < *Ndata_P_precal_negAdcPulseTime; i++) {
      ...
      h1PHGCERPulseTime[current_pmt]->Fill(-P_precal_negAdcPulseTime[i]);
      
      h1PHGCERPulseTimeStarttimeDiff[current_pmt]->Fill(-P_precal_negAdcPulseTime[i] + *P_hod_starttime); // no hit selection. Its adctdc time diff

      if(*P_ngcer_npeSum > 0.8)// all hits with electron 
	{
	  if(*P_gtr_dp>-15 && *P_gtr_dp<25)
	    {
	      h1_delta[current_pmt]->Fill(-P_precal_negAdcPulseTime[i] + *P_hod_starttime); //delta cut on no hit selection
	      
	      h1_gooddelta[current_pmt]->Fill(P_precal_goodNegAdcTdcDiffTime[current_pmt]); //delta cut on hit selection
	    }
	  
	  h1PHGCERPulseTimeStarttimeDiff_CalCut[current_pmt]->Fill(-P_precal_negAdcPulseTime[i] + *P_hod_starttime);  // adctdc time diff with multiplicity cut and calorimter cut
	  
	  h1TimeVsAmpCal[current_pmt]->Fill(-P_precal_negAdcPulseTime[i] + *P_hod_starttime, P_precal_negAdcPulseAmp[i]); // amplitude with electron
	  
	  h1goodTimeCal[current_pmt]->Fill(P_precal_goodNegAdcTdcDiffTime[current_pmt]); 
	}
      
      h1PHGCERPulseTimeVsPulseAmp[current_pmt]->Fill(-P_precal_negAdcPulseTime[i] + *P_hod_starttime,  P_precal_negAdcPulseAmp[i]);
      
      h1PHGCERPGoodAdcTdcDiffTime[current_pmt]->Fill(P_precal_goodNegAdcTdcDiffTime[current_pmt]);
      
      h1PHGCERPulseTimeVsPulseAmpMultCut[current_pmt]->Fill(P_precal_goodNegAdcTdcDiffTime[current_pmt], P_precal_goodNegAdcPulseAmp[current_pmt]); // hit selection with no cuts
      
      if (P_precal_goodNegAdcMult[current_pmt] == 1) //hits with mult
	{
	  h1PHGCERPulseTimeStarttimeDiffMult[current_pmt]->Fill(-P_precal_negAdcPulseTime[i] + *P_hod_starttime);// no hit selection with multiplicity cut
	  
	  h1PHGCERPGoodAdcTdcDiffTime_Mult[current_pmt]->Fill(P_precal_goodNegAdcTdcDiffTime[current_pmt]);
	  
	  h1goodTimeVsAmpMult[current_pmt]->Fill(P_precal_goodNegAdcTdcDiffTime[current_pmt], P_precal_goodNegAdcPulseAmp[current_pmt]);
	  
	  h1TimeVsAmpMult[current_pmt]->Fill(-P_precal_negAdcPulseTime[i] + *P_hod_starttime, P_precal_negAdcPulseAmp[i]);
	  
	  if(*P_ngcer_npeSum > 0.8)//hits with electron and Multiplicity
	    {
	      h1PHGCERPulseTimeStarttimeDiffMultCut[current_pmt]->Fill(-P_precal_negAdcPulseTime[i] + *P_hod_starttime);// all hit with elec and mult==1
	      
	      h1TimeVsAmpMultCal[current_pmt]->Fill(-P_precal_negAdcPulseTime[i] + *P_hod_starttime,  P_precal_negAdcPulseAmp[i]);
	      
	      h1goodTimeMultCal[current_pmt]->Fill(P_precal_goodNegAdcTdcDiffTime[current_pmt]);
	    }   
	}  
    }
...
void SHMSADCGates::Terminate()
{
  ...
  for (Int_t ipmt=0; ipmt < 14; ipmt++) {
    ...
    h1PHGCERPulseTimeStarttimeDiff_CalCut[ipmt]->GetXaxis()->SetTitle("-P.cal.pr.negAdcPulseTime + P.hod.starttime");
    ...
    h1PHGCERPulseTimeStarttimeDiff[ipmt]->GetXaxis()->SetTitle("-P.cal.pr.negAdcPulseTime + P.hod.starttime");
    ...
    h1PHGCERPulseTimeVsPulseAmp[ipmt]->GetXaxis()->SetTitle("-P.cal.pr.negAdcPulseTime + P.hod.starttime");
    h1PHGCERPulseTimeVsPulseAmp[ipmt]->GetYaxis()->SetTitle("P.cal.pr.negAdcPulseAmp");
    ...
    h1TimeVsAmpMult[ipmt ]->GetXaxis()->SetTitle("-P.cal.pr.negAdcPulseTime + P.hod.starttime");
    h1TimeVsAmpMult[ipmt ] ->GetYaxis()->SetTitle("P.cal.pr.negAdcPulseAmp");
    ...
    h1TimeVsAmpCal[ipmt ]->GetXaxis()->SetTitle("-P.cal.pr.negAdcPulseTime + P.hod.starttime");
    h1TimeVsAmpCal[ipmt ] ->GetYaxis()->SetTitle("P.cal.pr.negAdcPulseAmp");
    ...
    h1TimeVsAmpMultCal[ipmt ]->GetXaxis()->SetTitle("-P.cal.pr.negAdcPulseTime+ P.hod.starttime");
    h1TimeVsAmpMultCal[ipmt ] ->GetYaxis()->SetTitle("P.cal.pr.negAdcPulseAmp");
    ...
    legend[ipmtt]->Draw();
    //  delete legend[ipmtt];
   c1->SaveAs(Form("Plots/CAL_Neg_AdcTdc_pmt_%i.pdf", ipmt+1));
  ...
  for (Int_t ipmt=0; ipmt < 14; ipmt++) {
    ...
    h1PHGCERPGoodAdcTdcDiffTime[ipmt]->GetXaxis()->SetTitle("P.cal.pr.goodNegAdcTdcDiffTime");
    ...
    h1PHGCERPulseTimeVsPulseAmpMultCut[ipmt]->GetXaxis()->SetTitle("P.cal.pr.goodNegAdcTdcDiffTime");
    h1PHGCERPulseTimeVsPulseAmpMultCut[ipmt]->GetYaxis()->SetTitle("P.cal.pr.goodNegAdcPulseAmp");
    ...
    c0->SaveAs(Form("Plots/Good_CAL_Neg_AdcTdc_pmt_%i.pdf", ipmt+1));
    delete c0;
