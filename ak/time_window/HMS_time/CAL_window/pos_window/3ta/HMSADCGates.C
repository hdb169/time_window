...
Bool_t HMSADCGates::Process(Long64_t entry)
{
  ...
  if(entry<100000000) { //Abort("end of the desired entry");
    ...
    for (Int_t i = 0; i < *Ndata_H_cal_3ta_posAdcPulseTime; i++) {
      ...
      h1PHGCERPulseTime[current_pmt]->Fill(-H_cal_3ta_posAdcPulseTime[i]);
      
      h1PHGCERPulseTimeStarttimeDiff[current_pmt]->Fill(-H_cal_3ta_posAdcPulseTime[i] + *H_hod_starttime); // no hit selection. Its adctdc time diff

      if(*H_cer_npeSum > 2.0)// all hits with electron 
	{
	  if(*H_gtr_dp>-8 && *H_gtr_dp<10)
	    {
	      h1_delta[current_pmt]->Fill(-H_cal_3ta_posAdcPulseTime[i] + *H_hod_starttime); //delta cut on no hit selection
	      
	      h1_gooddelta[current_pmt]->Fill(H_cal_3ta_goodPosAdcTdcDiffTime[current_pmt]); //delta cut on hit selection
	    }
	  
	  h1PHGCERPulseTimeStarttimeDiff_CalCut[current_pmt]->Fill(-H_cal_3ta_posAdcPulseTime[i] + *H_hod_starttime);  // adctdc time diff with multiplicity cut and calorimter cut
	  
	  h1TimeVsAmpCal[current_pmt]->Fill(-H_cal_3ta_posAdcPulseTime[i] + *H_hod_starttime, H_cal_3ta_posAdcPulseAmp[i]); // amplitude with electron
	  
	  h1goodTimeCal[current_pmt]->Fill(H_cal_3ta_goodPosAdcTdcDiffTime[current_pmt]); 
	}
      
      h1PHGCERPulseTimeVsPulseAmp[current_pmt]->Fill(-H_cal_3ta_posAdcPulseTime[i] + *H_hod_starttime,  H_cal_3ta_posAdcPulseAmp[i]);
      
      h1PHGCERPGoodAdcTdcDiffTime[current_pmt]->Fill(H_cal_3ta_goodPosAdcTdcDiffTime[current_pmt]);
      
      h1PHGCERPulseTimeVsPulseAmpMultCut[current_pmt]->Fill(H_cal_3ta_goodPosAdcTdcDiffTime[current_pmt], H_cal_3ta_goodPosAdcPulseAmp[current_pmt]); // hit selection with no cuts
      
      if (H_cal_3ta_goodPosAdcMult[current_pmt] == 1) //hits with mult
	{
	  h1PHGCERPulseTimeStarttimeDiffMult[current_pmt]->Fill(-H_cal_3ta_posAdcPulseTime[i] + *H_hod_starttime);// no hit selection with multiplicity cut
	  
	  h1PHGCERPGoodAdcTdcDiffTime_Mult[current_pmt]->Fill(H_cal_3ta_goodPosAdcTdcDiffTime[current_pmt]);
	  
	  h1goodTimeVsAmpMult[current_pmt]->Fill(H_cal_3ta_goodPosAdcTdcDiffTime[current_pmt], H_cal_3ta_goodPosAdcPulseAmp[current_pmt]);
	  
	  h1TimeVsAmpMult[current_pmt]->Fill(-H_cal_3ta_posAdcPulseTime[i] + *H_hod_starttime, H_cal_3ta_posAdcPulseAmp[i]);
	  
	  if(*H_cer_npeSum > 2.0)//hits with electron and Multiplicity
	    {
	      h1PHGCERPulseTimeStarttimeDiffMultCut[current_pmt]->Fill(-H_cal_3ta_posAdcPulseTime[i] + *H_hod_starttime);// all hit with elec and mult==1
	      
	      h1TimeVsAmpMultCal[current_pmt]->Fill(-H_cal_3ta_posAdcPulseTime[i] + *H_hod_starttime,  H_cal_3ta_posAdcPulseAmp[i]);
	      
	      h1goodTimeMultCal[current_pmt]->Fill(H_cal_3ta_goodPosAdcTdcDiffTime[current_pmt]);
	    }   
	}  
    }
...
void HMSADCGates::Terminate()
{
  ...
  for (Int_t ipmt=0; ipmt < 13; ipmt++) {
    ...
    h1PHGCERPulseTimeStarttimeDiff_CalCut[ipmt]->GetXaxis()->SetTitle("-H.cal.3ta.posAdcPulseTime + H.hod.starttime");
    ...
    h1PHGCERPulseTimeStarttimeDiff[ipmt]->GetXaxis()->SetTitle("-H.cal.3ta.posAdcPulseTime + H.hod.starttime");
    ...
    h1PHGCERPulseTimeVsPulseAmp[ipmt]->GetXaxis()->SetTitle("-H.cal.3ta.posAdcPulseTime + H.hod.starttime");
    h1PHGCERPulseTimeVsPulseAmp[ipmt]->GetYaxis()->SetTitle("H.cal.3ta.posAdcPulseAmp");
    ...
    h1TimeVsAmpMult[ipmt ]->GetXaxis()->SetTitle("-H.cal.3ta.posAdcPulseTime + H.hod.starttime");
    h1TimeVsAmpMult[ipmt ] ->GetYaxis()->SetTitle("H.cal.3ta.posAdcPulseAmp");
    ...
    h1TimeVsAmpCal[ipmt ]->GetXaxis()->SetTitle("-H.cal.3ta.posAdcPulseTime + H.hod.starttime");
    h1TimeVsAmpCal[ipmt ] ->GetYaxis()->SetTitle("H.cal.3ta.posAdcPulseAmp");
    ...
    h1TimeVsAmpMultCal[ipmt ]->GetXaxis()->SetTitle("- H.cal.3ta.posAdcPulseTime+ H.hod.starttime");
    h1TimeVsAmpMultCal[ipmt ] ->GetYaxis()->SetTitle("H.cal.3ta.posAdcPulseAmp");
    ...
    legend[ipmtt]->Draw();
    //  delete legend[ipmtt];
   c1->SaveAs(Form("Plots/CAL_Pos_3ta_AdcTdc_pmt_%i.pdf", ipmt+1));
  ...
  for (Int_t ipmt=0; ipmt < 13; ipmt++) {
    ...
    h1PHGCERPGoodAdcTdcDiffTime[ipmt]->GetXaxis()->SetTitle("H.cal.3ta.goodPosAdcTdcDiffTime");
    ...
    h1PHGCERPulseTimeVsPulseAmpMultCut[ipmt]->GetXaxis()->SetTitle("H.cal.3ta.goodPosAdcTdcDiffTime");
    h1PHGCERPulseTimeVsPulseAmpMultCut[ipmt]->GetYaxis()->SetTitle("H.cal.3ta.goodPosAdcPulseAmp");
    ...
    h1goodTimeVsAmpMult[ipmt]->GetXaxis()->SetTitle("H.cal.3ta.goodPosAdcTdcDiffTime");
    h1goodTimeVsAmpMult[ipmt]->GetYaxis()->SetTitle("H.cal.3ta.goodPosAdcPulseAmp");
    ...
    c0->SaveAs(Form("Plots/Good_CAL_Pos_3ta_AdcTdc_pmt_%i.pdf", ipmt+1));
    delete c0;
